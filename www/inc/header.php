...
<html lang="en" class="fuelux">
    <head>
        ...
        <!-- Bootstrap -->
        <link rel="stylesheet" type="text/css" href="/css/app.css?987">
        <link href="/css/fuelux.css?987" rel="stylesheet" />
        <link href="/css/fuelux-responsive.css?987" rel="stylesheet" />
    ...
    <div class="row">
        <div id="viewLoader" class="span12 offset1">
            <div class="progress progress-striped active" style="width:50%;margin:100px auto 0;">
                <div class="bar" style="width:100%;"></div>
            </div>
            <div style="text-align:center;"><h3 id="loadingText">Loading...</h3></div>
        </div>
    </div>
